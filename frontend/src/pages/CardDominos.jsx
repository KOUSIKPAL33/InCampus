...
function CardDominos(props) {
  ...
  return (
    <>
      <div style={{ width: '18rem' }} className='border border-primary shadow p-3 mb-5 bg-body rounded'>
        ...
        <div className="card-body">
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            <div className=""><button className="btn btn-primary fs-6 p-1" onClick={handleCart}>Add to cart</button></div>
        </div>
      </div>
    </>
  )
